...
class Command(BaseCommand):
	...
	def load_teams(self):
		input_data = team_list = ['Buffalo Bills', 'New York Jets', 'New England Patriots', 'Miami Dolphins', 'Pittsburgh Steelers', 'Baltimore Ravens', 'Cleveland Browns', 'Cincinnati Bengals', 'Houston Texans', 'Indianapolis Colts', 'Jacksonville Jaguars', 'Tennessee Titans', 'Denver Broncos', 'Kansas City Chiefs', 'Oakland Raiders', 'Los Angeles Chargers', 'Philadelphia Eagles', 'Dallas Cowboys', 'Washington Redskins', 'New York Giants', 'Tampa Bay Buccaneers', 'Carolina Panthers', 'Atlanta Falcons', 'New Orleans Saints', 'Green Bay Packers', 'Minnesota Vikings', 'Chicago Bears', 'Detroit Lions', 'San Francisco 49ers', 'Seattle Seahawks', 'Arizona Cardinals', 'Los Angeles Rams']
	...
	def load_games(self):
		input_data = pd.read_csv("./app/management/Data/2019Games.csv", header=0).loc[:, :'Line']
